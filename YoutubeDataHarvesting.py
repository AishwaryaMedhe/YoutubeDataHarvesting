...
api_key = "AIzaSyDD4wk8FCZZGVtHDcUKioBh1MsrX9FpAl4"
...
if nav == "JSON Data":
    if st.session_state.ch_id:  # process only if the input have been passed
        ...
        mongo = pymongo.MongoClient("mongodb+srv://Aishwarya:Aishwarya@cluster0.qigwtrl.mongodb.net/?retryWrites=true&w=majority")
        mydb = mongo["YOUTUBE"]
        mycollection = mydb['DATA']
...
def table(df):
    ...
    engine = create_engine('mysql+mysqlconnector://root:Dreamer_1@localhost/youtube', echo=False)
...
# enter 'streamlit run "YoutubeDataHarvesting.py" in pycharm terminal